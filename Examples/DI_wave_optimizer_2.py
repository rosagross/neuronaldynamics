...
model_parameter_bounds = [[150, 400], [0.25, 0.75], [0.9, 1.0], [0.5, 0.8], [0, 50]]  # frac exc was 0.2 min
...
#                                        'input_type': 'current'},
#                   'enable_high_pass': False}
# di_model_opt = DI_wave_simulation(parameters=parameters, logname=None)
# di_model_opt.simulate()
# di_model_opt.mass_model.plot(heat_map=True, plot_input=True)
# di_model_opt.plot_validation()
# di_model_opt.save_log(plot=True)
...
opt_parameters = {'optimizer': 'hierarchical', 'eps': 0.05, 'max_iter': 5, 'n_grid': 10,
                  'model_parameters': model_parameters, 'bounds': model_parameter_bounds, 'x_out': 'mass_model_v_out',
                  'fn_session': fn_session, 'T': 20, 'nykamp_parameters': {'tqdm_disable': True}, 'dt': 0.05,
...
opt_param_dict = {'intensity': opt_params[0], 'fraction_nmda': opt_params[1], 'fraction_gaba_a': opt_params[2],
                  'fraction_ex': opt_params[3], 'fn_session': fn_session, 'T': 8, 'name': simulation_name, 'dt': 0.05,

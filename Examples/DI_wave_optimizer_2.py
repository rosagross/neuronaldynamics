...
simulation_name = 'diw_opt_25_09_09_2'
parameters = {'intensity': 220, 'fraction_nmda': 0.5, 'fraction_gaba_a': 0.95, 'fraction_ex': 0.4, 'plot_align': False,
              ...
              'fn_session': fn_session, 'T': 8, 'name': simulation_name, 'dt': 0.01, 'enable_high_pass': False,
...
model_parameter_bounds = [[200, 400], [0.25, 0.75], [0.9, 1.0], [0.2, 0.8], [0, 100]]
opt_parameters = {'optimizer': 'hierarchical', 'eps': 0.05, 'max_iter': 5, 'n_grid': 50,
                  ...
                  'fn_session': fn_session, 'T': 8, 'nykamp_parameters': {'tqdm_disable': True}, 'dt': 0.01,

...
intensities = np.linspace(150, 400, 50)
connectivities = np.linspace(0, 30, 50)
# errors = np.zeros((50, 50))
# differences = np.zeros((50, 50))
#
#
# for i, _ in enumerate(tqdm(range(50))):
#     for j in range(50):
...
#
# with h5py.File('2D_sweep_data.hdf5', 'w') as h5file:
...
with h5py.File('2D_sweep_data.hdf5', 'r') as h5file:

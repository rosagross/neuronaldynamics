...
lif = LIF_population(T=T, tau_m=20, tref=3,  weights=con, n_neurons=dim, Iext=in_sine, verbose=0)
lif.gen_poisson_spikes_input(rate=1.0, i_max=1e4, delay=True) #input in nA? #rate of 0.5 seems to be fitting for nykamp plot
lif.run()

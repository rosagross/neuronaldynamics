...
# TODO: exclude C, include pdf weight, offset and sigma, use i_scale*350 value
...
model_parameter_bounds = [[250, 400], [0.25, 0.75], [0.9, 1.0], [0.5, 0.8]]  # frac exc was 0.2 min
...
opt_parameters = {'intensity': opt_params[0], 'fraction_nmda': opt_params[1], 'fraction_gaba_a': opt_params[2],
                  'fraction_ex': opt_params[3], 'plot_align': False,
              'test_func_intensity': 2.5, 'test_func_t0': 0.25,
              'test_signal_from_file': True,
              'fn_session': fn_session, 'T': 10, 'name': simulation_name, 'dt': 0.02, 'enable_high_pass': False,

...
simulation_name = 'diw_2025_09_12_01'
...
parameters = {'intensity': 350, 'fraction_nmda': 0.70, 'fraction_gaba_a': 0.98, 'fraction_ex': 0.70, 'plot_align': False,
              ...
              'nykamp_parameters': {'connectivity_matrix': np.array([[22]]),
                                    'tau_ref': [1.5],
                                    'tau_mem': [12],
                                    'input_type': 'current',
                                    'init_pdf_sigma': 1.0}}

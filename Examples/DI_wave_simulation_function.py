...
parameters = {'intensity': 182, 'fraction_nmda': 0.75, 'fraction_gaba_a': 0.90, 'fraction_ex': 0.65, 'plot_align': False,
              ...
              'nykamp_parameters': {'connectivity_matrix': np.array([[3.35]]),
                                    'tau_ref': [1.5],
                                    'tau_mem': [12],
                                    'input_type': 'current',
                                    'init_pdf_sigma': 1.0}}
...
di_model.simulate()
di_model.mass_model.plot(heat_map=True, plot_input=False, plot_combined=False, z_limit=0.15, animate=True)
